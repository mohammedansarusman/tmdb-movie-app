...
const MovieShimmer = () => {
    ...
    return (
        <div className="w-screen bg-gradient-to-br from-slate-900 to-gray-700 text-white relative py-20 pl-5 flex flex-col">
            <div className = 'flex justify-center gap-1 lg:gap-3'>
                {Array.from({ length: count }).map(() => (
                    <div className="w-[50px] h-[75px] bg-gray-500 rounded-xl"></div>
                ))}
            </div>
